...
def time_distributed_basic_2d(
    ...
    def f(x):
        ...
        y = keras.layers.TimeDistributed(layers.BatchNormalization(axis=axis, epsilon=1e-5, freeze=freeze_bn), name="bn{}{}_branch2a".format(stage_char, block_char))(y)
        ...
        y = keras.layers.TimeDistributed(layers.BatchNormalization(axis=axis, epsilon=1e-5, freeze=freeze_bn), name="bn{}{}_branch2b".format(stage_char, block_char))(y)
        ...
        if block == 0:
            ...
            shortcut = keras.layers.TimeDistributed(
                layers.BatchNormalization(axis=axis, epsilon=1e-5, freeze=freeze_bn), name="bn{}{}_branch1".format(stage_char, block_char))(shortcut)
        else:
            shortcut = x
...
def time_distributed_bottleneck_2d(
    ...
    def f(x):
        ...
        y = keras.layers.TimeDistributed(layers.BatchNormalization(axis=axis, epsilon=1e-5, freeze=freeze_bn), name="bn{}{}_branch2c".format(stage_char, block_char))(y)
